...
class MyWindow(QMainWindow):
    ...
    def giveChoice(self,defiList):
        ...
        self.layout.removeWidget(self.notificationText)
        self.choice_dict = {}
        for i,numDefi in enumerate(defiList):
            ...
            defi.setStyleSheet("border: 1px solid black;padding-top:15px;padding-left:10px;padding-right:10px")
            ...
            self.choice_dict[key].clicked.connect(lambda :self.choiceButtonClicked(key))
