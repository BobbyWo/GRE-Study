...
class MyWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.searchOpen.setText("Image to String(Question)")
        self.searchOpen.move(int((self.win_width / 4 * (x-1)) + 10), 75)
        ...
        self.copyPartNum.setText("Image to String(Answer)")
        self.copyPartNum.move(int((self.win_width / 4 * (x-1)) + 10), 75)
        ...
        self.createTable.clicked.connect(self.snip_copy_clicked)
        x += 1
        ...
        self.paraTrans.clicked.connect(self.snip_copy_clicked)
